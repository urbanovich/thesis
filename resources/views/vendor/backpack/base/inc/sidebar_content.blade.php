...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('event_types') }}'>
        <i class='nav-icon la la-cloud'></i>  {{ trans('admin.events') }}</a>
</li><li class='nav-item'><a class='nav-link' href='{{ backpack_url('events') }}'>
        <i class='nav-icon la la-cloud'></i>  {{ trans('admin.events') }}</a></li>
